...
var Feedback = Backbone.Model.extend(
	{
		...
		setCookie: function ( model, value ) {
			...
			jQuery( document ).trigger( 'user_feedback:cookie_set', { do_not_show_again: value } );
		}
	}
);
...
var __t,__p='',__j=Array.prototype.join,print=function(){__p+=__j.call(arguments,'');};
with(obj||{}){
__p+='<button class="user-feedback-button user-feedback-button-gray user-feedback-button-init" accesskey="u" tabindex="1" aria-label="'+
((__t=( labelAria ))==null?'':__t)+
'">\n\t'+
((__t=( label ))==null?'':__t)+
'\n</button>\n';
}
...
__p+='<div class="user-feedback-modal" role="dialog">\n\t<span class="user-feedback-modal__arrow"></span>\n\t<div class="user-feedback-modal__topbar">\n\t\t<h3 class="user-feedback-modal-title">'+
((__t=( title ))==null?'':__t)+
'</h3>\n\t\t<button class="user-feedback-button user-feedback-button-close" aria-label="'+
((__t=( button.closeAria ))==null?'':__t)+
'" tabindex="2">\n\t\t\t'+
((__t=( button.close ))==null?'':__t)+
'\n\t\t</button>\n\t</div>\n\n\t<p>\n\t\t<textarea id="user-feedback-overview-note" class="user-feedback-textarea" placeholder="'+
...
},{"1":1,"8":8}],8:[function(require,module,exports){
'use strict';

var Button = require(10),
    Bubble = require(9);
...
},{"10":10,"9":9}],9:[function(require,module,exports){
'use strict';
...
},{"11":11,"12":12,"13":13,"2":2}],10:[function(require,module,exports){
'use strict';
...
window.html2canvas = require(14); // Apparently needs to be globally accessible.
...
},{"6":6}],14:[function(require,module,exports){
(function (global){
/*
